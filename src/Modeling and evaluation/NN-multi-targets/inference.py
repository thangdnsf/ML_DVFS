...
content = f'loss_valid: {loss_valid:.5f}, roc_auc_target: {roc_auc_target:.6f}, roc_auc_targetZ: {roc_auc_targetZ:.6f}, total_roc_auc: {roc_auc:.6f},\
    F1_target: {F1_target:.6f},F1_targetZ: {F1_targetZ:.6f},accuracy_target: {accuracy_target:.6f}, accuracy_targetZ: {accuracy_targetZ:.6f}, mean_squared_error: {mean_squared_error(TARGETS_target_id, PREDS_target_id)} .'
print(content)
